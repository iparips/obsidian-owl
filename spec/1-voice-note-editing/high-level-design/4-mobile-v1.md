...
Covers release 4 of [2-plan.md](../2-plan.md): streaming on mobile via ephemeral tokens, graceful fallback, mic lifecycle, and the public release. Delta design on top of [3-desktop-v1.md](3-desktop-v1.md).
